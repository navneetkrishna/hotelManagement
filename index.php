...
<body>
    <div class="container">
       ...
       <img class="img-responsive" src="images/home_banner4.jpg" style="width:100%; height:180px;">      
        ...
        <div class="row" style="color: #ffbb2b">
            <div class="col-md-4 wellfix">
              ...
              <p style="color:white; font-size:19px;"> Address : Delhi India</p>
              <p style="color:white; font-size:19px;"> Mail : hotelbookings@gmail.com </p><br>
            </div>
            <div class="col-md-4"></div>
            <div class="col-md-4 wellfix">
                <h4><strong>Developed By</strong></h4><hr>
                <a href="#" style="font-size:20px;">@Navneet Krishna</a>
